 ...
 function rgbtoyiq_fixpt_xsgbbxcfg(this_block)
 % Set target language
 this_block.setTopLevelLanguage('Verilog');
 % Set top entity name
 this_block.setEntityName('rgbtoyiq_fixpt');
 ...
 this_block.addSimulinkOutport('i');
 i_obj = this_block.port('i');
 i_obj.setType('UFix_8_0');
 this_block.addSimulinkOutport('q');
 q_obj = this_block.port('q');
 q_obj.setType('UFix_8_0');
 ...
 %s Add HDL files
 this_block.addFile('C:\Users\Sechw\Documents\MATLAB\4440\codegen\rgbtoyiq\hdlsrc\rgbtoyiq_fixpt.v');
% ------------------------------------------------------------
