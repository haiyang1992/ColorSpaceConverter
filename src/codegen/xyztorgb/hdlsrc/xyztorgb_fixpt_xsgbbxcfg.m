 ...
 function xyztorgb_fixpt_xsgbbxcfg(this_block)
 % Set target language
 this_block.setTopLevelLanguage('Verilog');
 % Set top entity name
 this_block.setEntityName('xyztorgb_fixpt');
 ...
 this_block.addSimulinkInport('z');
 ...
 if (this_block.inputTypesKnown)
	 ...
	 if(this_block.port('x').width ~= 8)
		 this_block.setError('Input data type for port "x" must have width = 8.');
	 end
	 if(this_block.port('y').width ~= 8)
		 this_block.setError('Input data type for port "y" must have width = 8.');
	 end
	 if(this_block.port('z').width ~= 8)
		 this_block.setError('Input data type for port "z" must have width = 8.');
	 end
 end
 ...
 %s Add HDL files
 this_block.addFile('C:\Users\Sechw\Documents\MATLAB\4440\codegen\xyztorgb\hdlsrc\xyztorgb_fixpt.v');
% ------------------------------------------------------------
