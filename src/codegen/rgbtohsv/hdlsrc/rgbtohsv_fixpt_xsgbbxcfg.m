 ...
 function rgbtohsv_fixpt_xsgbbxcfg(this_block)
 % Set target language
 this_block.setTopLevelLanguage('Verilog');
 % Set top entity name
 this_block.setEntityName('rgbtohsv_fixpt');
 ...
 this_block.addSimulinkOutport('h');
 h_obj = this_block.port('h');
 h_obj.setType('UFix_8_0');
 this_block.addSimulinkOutport('s');
 s_obj = this_block.port('s');
 s_obj.setType('UFix_8_0');
 this_block.addSimulinkOutport('v');
 v_obj = this_block.port('v');
 v_obj.setType('UFix_8_0');
 ...
 %s Add HDL files
 this_block.addFile('C:\Users\Sechw\Documents\MATLAB\4440\codegen\rgbtohsv\hdlsrc\rgbtohsv_fixpt.v');
% ------------------------------------------------------------
